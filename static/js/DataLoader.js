function LocalStorageState() {
    ...
    this.get_all_cards = function(table_id) {
        return '[{"id":1, "title":"task", "description":"this is a good task men", "status":"new", "order":0}, {"id":2, "title":" second task", "description":"second this is a good task men", "status":"in-progress", "order":1}, {"id":3, "title":"third task", "description":"third this is a good task men", "status":"new", "order":2}]';
    };
